...
# Path to the pre-year details file
pre_year_details_file = os.path.join(input_dir, f'pre_{YEAR_THRESHOLD}_details_tokenized.csv')
...
# Predict on pre-year details
pre_output_file = os.path.join(output_dir, f'pre_{YEAR_THRESHOLD}_details_predictions.csv')
predict_on_dataset(pre_year_details_file, pre_output_file)
