"""
Load a dataset and train a BERT classifier using pre-tokenized details data.
"""
...
# Input directory for tokenized train and val details files
input_dir = f"{PROJ_DIR}/data/processed_data/details/{SECTION}-{YEAR_THRESHOLD}"

train_file = os.path.join(input_dir, f'train_{YEAR_THRESHOLD}_details_tokenized.csv')
val_file = os.path.join(input_dir, f'val_{YEAR_THRESHOLD}_details_tokenized.csv')

# Directory to save and load checkpoints
checkpoint_dir = f"{PROJ_DIR}/src/model_training/details/model-checkpoint"
